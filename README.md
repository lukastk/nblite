...
nblite is a lightweight tool for developing Python packages using Jupyter notebooks as the source of truth. Write your code in notebooks, add export directives, and nblite generates clean Python modules automatically.
