...
def export_to_lib_as_func(nb_path: str, lib_path: str, nb_format: str = None):
    ...
    __all__line_index = next((i for i, line in enumerate(py_file_content.splitlines()) if line.startswith('__all__')), 1)
    py_file_content = "\n".join(py_file_content.splitlines()[__all__line_index+1:]).strip()
