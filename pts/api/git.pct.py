...
# %%
import nblite.git as this

# %%
show_doc(this.has_unstaged_changes)
...
# %%
show_doc(this.list_staged_files)
...
# %%
show_doc(this.list_unstaged_and_untracked_files)
...
# %%
show_doc(this.get_unstaged_nb_twins)
